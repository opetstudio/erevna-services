...
function run(options){
    var localStorageKeyName = options.localStorageKeyName || constanta['localstorage-property-types-synonym'];
    async.series([
...
//        doc.useServiceAccountAuth(creds, step);
    ...
    //      console.log('Loaded doc: ',info);
          ...
          console.log('get info sheet 3: '+sheet.title+' '+sheet.rowCount+'x'+sheet.colCount);
          step();
        });
      },
    ...
    //        console.log('dataJson: ',dataJson);
            ...
            console.log('test data|'+dataJsonFromLocalstorage['tanah garapan']+'|');
